 ...
 *   "That's what happens when the facts hold up." 52.32 - 53.84
 *   "Awesome Attorneys"                           54.14 - 55.24
 *   "matches you directly with a Phoenix Injury Attorney." 55.64 - 57.84
 *   "Get matched,"                                58.74
 *   "get paid."                                   59.54
 *   "AwesomeAttorneys.com"                        60.54 - 61.18
 */
const B = {
  headline: cue('cta', 52.32) + 2,
  headlineOut: cue('cta', 53.9) - 12,
  brand: cue('cta', 54.14) - 6,
  matched: cue('cta', 55.64) - 5,
  getMatched: cue('cta', 58.74) - 7,
  getPaid: cue('cta', 59.54) - 7,
  url: cue('cta', 60.54) - 7,
};
...
export const Scene09CTA: React.FC = () => {
  ...
  const urlPop = spring({frame: frame - B.url, fps, config: {damping: 13, mass: 0.7}});
          ...
          <>
            <div
              style={{
                ...
                opacity: interpolate(frame, [B.brand, B.brand + 14], [0, 1], {extrapolateRight: 'clamp'}),
                transform: `translateY(${interpolate(frame, [B.brand, B.brand + 18], [30, 0], {
            ...
            <div style={{display: 'flex', gap: 22, marginTop: 16}}>
              <Pill text="GET MATCHED" startAt={B.getMatched} />
              <Pill text="GET PAID" startAt={B.getPaid} />
            </div>
            <div
              style={{
                marginTop: 34,
